...
class HomeController extends Controller
{
    ...
    public function exportSuratPembagianWaris() {
        $pdf = PDF::loadView('export-surat-pembagian-waris.export')->setPaper('a4', 'portrait');
        return $pdf->stream();
    }

    public function exportSilsilahWaris() {
        $pdf = PDF::loadView('export-silsilah-waris.export')->setPaper('a4', 'portrait');
        return $pdf->stream();
    }

    public function exportKeteranganAhliWaris2() {
        $pdf = PDF::loadView('export-keterangan-ahli-waris.export2')->setPaper('a4', 'portrait');
        return $pdf->stream();
    }

    public function exportSuratTebangPohon() {
        $pdf = PDF::loadView('export-surat-tebang-pohon.export')->setPaper('a4', 'portrait');
        return $pdf->stream();
    }
}
